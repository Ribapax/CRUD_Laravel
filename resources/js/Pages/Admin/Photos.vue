                ...
                <table class="min-w-full divide-y divide-gray-200">
                  <thead class="bg-gray-50">
                    <tr>
                      ...
                      <th scope="col"
                        class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Photos</th>
                      <th scope="col"
                    ...
                    <tr v-for="photo in photos" :key="photo.id">
                      ...
                      <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <a  class="text-indigo-600 hover:text-indigo-900">
                          <primary-button type="button" :href="route('admin.photos.show',photo)" >
                            View
                          </primary-button>
                          <secondary-button type="button" :href="route('admin.photos.edit',photo)">
                            Edit
                          </secondary-button>
...
export default defineComponent({
  components: {
    ...
    // TableComponent,
    JetDialogModal,
    JetDangerButton, PrimaryButton,SecondaryButton
  },
  props: {
    photos: Array,
  },
